...
func main() {
	...
	relay.Router().HandleFunc("/favorites", favoritesPageHandler)
	relay.Router().HandleFunc("/internal", internalPageHandler)
	relay.Router().HandleFunc("/groups", groupsPageHandler)
